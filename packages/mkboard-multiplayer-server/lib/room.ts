...
import { nextQuote } from "@mkboard/content-quotes";
import { type Task, Tasks, Timer } from "@mkboard/lang";
import {
  type ClientMessage,
  GAME_CONFIG_ID,
  GAME_READY_ID,
  ...
  type PlayerState,
  type ServerMessage,
} from "@mkboard/multiplayer-shared";
import { computeSpeed, countErrors } from "@mkboard/textinput";
