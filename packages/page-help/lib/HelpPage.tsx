...
import { KeyLayer, VirtualKeyboard, ZonesLayer } from "@mkboard/keyboard-ui";
import { KeyLegendList } from "@mkboard/lesson-ui";
import { useSettings } from "@mkboard/settings";
import { singleLine, toTextDisplaySettings } from "@mkboard/textinput";
import { StaticText } from "@mkboard/textinput-ui";
import { Article, Figure } from "@mkboard/widget";
