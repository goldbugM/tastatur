...
import { Color, parseColor } from "@mkboard/color";
import { rootDir } from "@mkboard/scripts/root.js";
import { CustomTheme, themeProps, themePropsMap } from "@mkboard/themes";
...
function formatSourceCode(themes: Map<string, CustomTheme>): string {
  ...
  lines.push(``);
  lines.push(`import { parseColor } from "@mkboard/color";`);
  lines.push(`import { CustomTheme } from "@mkboard/themes";`);
