...
import { hasData, Histogram, KeySet, Range } from "@mkboard/math";
import { type KeyStatsMap, timeToSpeed } from "@mkboard/result";
import { Canvas, type Rect, type ShapeList } from "@mkboard/widget";
